...
export const varanasi: TempoTravellerData = {
  ...
  image: "/assets/images/vehicles/tempo-traveller.jpg",
  capacity: 17,
  pricePerKm: 22,
  basePrice: 4000,
  features: [
...
export const varanasiLuxury: TempoTravellerData = {
  ...
  image: "/assets/images/vehicles/luxury-tempo.jpg",
  capacity: 12,
  pricePerKm: 28,
  basePrice: 5500,
  features: [
...
export const lucknowMaharaja: TempoTravellerData = {
  ...
  image: "/assets/images/vehicles/maharaja-tempo.jpg",
  capacity: 9,
  pricePerKm: 32,
  basePrice: 6500,
  features: [
...
export const lucknowUrbania: TempoTravellerData = {
  ...
  image: "/assets/images/vehicles/urbania.jpg",
  capacity: 17,
  pricePerKm: 30,
  basePrice: 6000,
  features: [
